...
{
    // Класс модели, которую мы отдадим пользователю на клиентскую часть (фронтенд)
    public class NoteDetailsVm:IMapWith<Note>
    {
        ...
        {
            profile.CreateMap<Note, NoteDetailsVm>().ForMember(noteVm => noteVm.Title, opt => opt.MapFrom(note => note.Title))
